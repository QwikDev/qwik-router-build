...
var _a, _b;
REQ_COOKIE, _b = RES_COOKIE, _a = LIVE_COOKIE;
var Cookie = class {
...
// packages/qwik-router/src/buildtime/routing/source-file.ts
...
// packages/qwik-router/src/buildtime/routing/parse-pathname.ts
...
// packages/qwik-router/src/buildtime/routing/walk-routes-dir.ts
...
// packages/qwik-router/src/buildtime/routing/walk-server-plugins.ts
...
// packages/qwik-router/src/buildtime/markdown/syntax-highlight.ts
init_unist_util_visit();
...
/** Qwik Router Entries Entry */`);
    c2.push(`export const e = () => import("@qwik-router-entries");
`);
  }
}
...
// packages/qwik-router/src/buildtime/runtime-generation/utils.ts
...
// packages/qwik-router/src/buildtime/runtime-generation/generate-menus.ts
...
// packages/qwik-router/src/buildtime/runtime-generation/generate-server-plugins.ts
...
var DEV_SERVICE_WORKER = `/* Qwik Router Dev Service Worker */
...
// packages/qwik-router/src/buildtime/vite/validate-plugin.ts
...
var QWIK_ROUTER_CONFIG_ID = "@qwik-router-config";
var QWIK_ROUTER_ENTRIES_ID = "@qwik-router-entries";
var QWIK_ROUTER = "@qwik.dev/router";
var QWIK_ROUTER_SW_REGISTER = "@qwik-router-sw-register";
    ...
    async load(id, opts) {
      if (ctx) {
        ...
        if (isRouterConfig || isSwRegister) {
          ...
          if (isRouterConfig) {
            return generateQwikRouterConfig(ctx, qwikPlugin, (opts == null ? void 0 : opts.ssr) ?? false);
          }
          if (isSwRegister) {
            return generateServiceWorkerRegister(ctx, qwik_router_sw_register_build_default);
          }
        }
      }
      return null;
